...
public class Level3Controller
{
    ...
    private TextField textField1, textField2, textField3, textField4, textField5, textField6, textField7,
            ...
            textField34, textField35, textField36,textField37,textField38,textField39,textField40,textField41,textField42,textField43,textField44;

    @FXML
    private Text incorrectWord1, incorrectWord2, incorrectWord3, incorrectWord4, incorrectWord5,
            incorrectWord6,incorrectWord7;
    ...
    void initialize() // створюємо масив полів. В кожній комірці масива слово
    {
        ...
        textFieldList.add(Arrays.asList(textField1, textField2, textField3, textField4, textField5, textField6, textField7, textField8, textField9));
        textFieldList.add(Arrays.asList(textField10, textField11, textField3, textField12, textField13, textField14, textField15));
        textFieldList.add(Arrays.asList(textField6, textField16, textField17, textField18, textField19, textField20));
        textFieldList.add(Arrays.asList(textField21, textField22, textField23, textField24, textField8, textField25, textField26, textField27));
        textFieldList.add(Arrays.asList(textField28, textField29,textField30, textField31, textField14, textField32));
        textFieldList.add(Arrays.asList(textField28,textField33, textField34, textField35, textField36, textField37, textField38, textField39, textField40));
        textFieldList.add(Arrays.asList(textField36, textField41, textField42, textField43,textField44));

        incorrectWordList = Arrays.asList(incorrectWord1, incorrectWord2, incorrectWord3, incorrectWord4,
                incorrectWord5, incorrectWord6,incorrectWord7);
    ...
    public void setCorrectWords() // з файлу дістати слова
    {
        ...
        try
        {
            BufferedReader reader = new BufferedReader(new FileReader("src/Levels/Level3/level3Words.txt"));
    ...
    private void checkAllWordsCorrectlyEntered()
    {
        ...
        if (winStage == null)
        {
            try
            {
                ...
                Parent klitschkoRoot = FXMLLoader.load(getClass().getResource("/Levels/Level3/Avramenko/Avramenko.fxml"));
                winStage = new Stage();
    ...
    @FXML
    void switchTo_Choose(ActionEvent event) throws IOException
    { //кнопка виходу
