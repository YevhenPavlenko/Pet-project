...
public class Level4Controller
{
    ...
    private Text incorrectWord1, incorrectWord2, incorrectWord3, incorrectWord4, incorrectWord5,
            incorrectWord6, incorrectWord7, incorrectWord8, incorrectWord9;
    ...
    void initialize() // створюємо масив полів. В кожній комірці масива слово
    {
        ...
        textFieldList.add(Arrays.asList(textField1, textField2, textField3, textField4, textField5));
        textFieldList.add(Arrays.asList(textField6, textField7, textField8, textField3, textField9));
        textFieldList.add(Arrays.asList(textField10, textField11, textField5));
        textFieldList.add(Arrays.asList(textField10, textField12, textField13, textField14, textField15));
        textFieldList.add(Arrays.asList(textField15, textField16,textField17));
        textFieldList.add(Arrays.asList(textField18,textField19, textField20, textField21, textField22, textField23, textField24, textField25, textField14));
        textFieldList.add(Arrays.asList(textField30, textField29, textField28, textField27,textField26, textField20));
        textFieldList.add(Arrays.asList(textField30, textField31, textField32, textField33));
        textFieldList.add(Arrays.asList(textField34, textField28, textField35, textField36));

        incorrectWordList = Arrays.asList(incorrectWord1, incorrectWord2, incorrectWord3, incorrectWord4,
                incorrectWord5, incorrectWord6,incorrectWord7, incorrectWord8, incorrectWord9);
    ...
    public void setCorrectWords() // з файлу дістати слова
    {
        ...
        try
        {
            BufferedReader reader = new BufferedReader(new FileReader("src/Levels/Level4/level4Words.txt"));
            String s = "";
    ...
    private void checkAllWordsCorrectlyEntered()
    {
        ...
        if (winStage == null)
        {
            try
            {
                ...
                Parent klitschkoRoot = FXMLLoader.load(getClass().getResource("/Levels/Level4/Farion/Farion.fxml"));
                winStage = new Stage();
